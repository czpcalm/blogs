...
这部分在脚本写作中使用较多，具体展开规则请查看 [bash 手册](https://www.gnu.org/software/bash/manual/html_node/Shell-Parameter-Expansion.html)。
...
在双引号内，只有 `$` 和 `` ` `` 还有特殊作用，所以只有 2-4 还有效。
